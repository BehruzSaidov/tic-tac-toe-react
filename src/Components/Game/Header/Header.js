...
export default React.memo(function Header({player,resetRequest}) {
  return (
    <header className="flex justify-between items-center mb-[20px]">
      <div className="max-w-[72px] flex-1 flex justify-between">
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
      ...
      <div className="pt-[13px] pr-[30px] pb-[19px] pl-[30px] bg-[--1f3] rounded-[10px] flex items-center shadow-b4">
        {!player ? (
          <svg
            width="20"
            height="20"
        ...
        <span className="font-[700] text-[16px] uppercase pl-[13px] text-[--a8b]">
          Turn
        </span>
      </div>

      <button
        className="p-[16px] shadow-b5 bg-[--a8b] rounded-[10px] outline-none border-none cursor-[--cursor] hover:bg-[--dbe]"
        title="Reset Game"
